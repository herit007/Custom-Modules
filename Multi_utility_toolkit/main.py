...
from datetime_ops import timemodule
...
class MathModule:
    ...
    def trigonometry():
        ...
        radians = math.radians(angle)  # convert degrees → radians
...
while True:
    ...
    if choice == 1:
        while True:
            ...
            if choice == 1:
                timemodule.currenttime()

            elif choice == 2:
                timemodule.calculatediffer()

            elif choice == 3:
                timemodule.customdate()

            elif choice == 4:
                timemodule.stopwatch()

            elif choice == 5:
                timemodule.countdown()
